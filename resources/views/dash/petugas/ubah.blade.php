      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-6">
            ...
            <form action="/dash/petugas/{{ $petugas->id }}" method="post">
              @method('put')
              @csrf
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('namapetugas') is-invalid @enderror" name="namapetugas"
                  id="namapetugas" value="{{ old('namapetugas', $petugas->namapetugas) }}" autofocus required>
                @error('namapetugas')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nippetugas') is-invalid @enderror" name="nippetugas"
                  id="nippetugas" value="{{ old('nippetugas', $petugas->nippetugas) }}" required>
                @error('nippetugas')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
