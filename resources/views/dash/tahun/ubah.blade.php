      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-6">
            ...
            <form action="/dash/tahun/{{ $tahun->id }}" method="post">
              @method('put')
              @csrf
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tahun') is-invalid @enderror" name="tahun"
                  id="tahun" value="{{ old('tahun', $tahun->tahun) }}" autofocus required>
                @error('tahun')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('hijriah') is-invalid @enderror" name="hijriah"
                  id="hijriah" value="{{ old('hijriah', $tahun->hijriah) }}" required>
                @error('hijriah')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
