      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-10">
            ...
            <form class="mb-5" action="/dash/pelimpahan/{{ $pelimpahan->id }}" method="post">
              @method('put')
              @csrf

              <div class="card bg-white kotak2 rounded mb-3">
                <h5 class="card-header bg-dark">Ubah Data Pelimpahan</h5>
                <div class="card-body">

                  <div class="form-row">
                    <div class="col-md-3 mb-2">
                      <label for="tglproses">Tanggal Pengajuan</label>
                      <input type="hidden" name="proses" id="proses" value="{{ $pelimpahan->proses }}">
                      <input type="date" class="form-control bg-warning" name="tglproses" id="tglproses" value="{{ old('tglproses',$pelimpahan->tglproses) }}" readonly required>
                    </div>
                    ...
                    <div class="col-md-3 mb-2">
                      ...
                      <select class="custom-select" name="alasanpelimpahan" id="alasanpelimpahan" required>
                        @foreach ($alasan as $item)
                          @if (old('alasanpelimpahan',$pelimpahan->alasan) == $item->alasan)
                    ...
                    <div class="col-md-5 mb-2">
                      ...
                      <input type="text" class="form-control @error('tglsurat') is-invalid @enderror" name="tglsurat" id="tglsurat" value="{{ old('tglsurat',$pelimpahan->tglsurat) }}" autofocus required>
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="bulanproses" id="bulanproses" required>
                        @foreach ($bulans as $item)
                          @if (old('bulanproses',$pelimpahan->bulanproses) == $item->namabulan)
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="tahun_id" id="tahun_id" required>
                        @foreach ($tahuns as $item)
                          @if (old('tahun_id',$pelimpahan->tahun_id) == $item->id)
                  ...
                  <div class="form-row">
                    <div class="col-md-2 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('porsi') is-invalid @enderror" name="porsi" id="porsi" value="{{ old('porsi',$pelimpahan->porsi) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('porsi')
                    ...
                    <div class="col-md-5 mb-3">
                      ...
                      <input type="text" class="form-control @error('namajamaah') is-invalid @enderror" name="namajamaah" id="namajamaah" value="{{ old('namajamaah',$pelimpahan->namajamaah) }}" onkeyup="hb1()" required>
                      @error('namajamaah')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-5 mb-3">
                      ...
                      <input type="text" class="form-control @error('binjamaah') is-invalid @enderror" name="binjamaah" id="binjamaah" value="{{ old('binjamaah',$pelimpahan->binjamaah) }}" onkeyup="hb2()" required>
                      @error('binjamaah')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="col-md-3">
                      ...
                      <input type="date" class="form-control @error('tglsuratpermohonan') is-invalid @enderror" name="tglsuratpermohonan" id="tglsuratpermohonan" value="{{ old('tglsuratpermohonan',$pelimpahan->tglsuratpermohonan) }}" required>
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="date" class="form-control @error('tglberitaacara') is-invalid @enderror" name="tglberitaacara" id="tglberitaacara" value="{{ old('tglberitaacara',$pelimpahan->tglberitaacara) }}" required>
                  ...
                  <div class="form-row">
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('ktppenerima') is-invalid @enderror" name="ktppenerima" id="ktppenerima" value="{{ old('ktppenerima',$pelimpahan->ktppenerima) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('ktppenerima')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('hppenerima') is-invalid @enderror" name="hppenerima" id="hppenerima" value="{{ old('hppenerima',$pelimpahan->hppenerima) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('hppenerima')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-5 mb-3">
                      ...
                      <input type="text" class="form-control @error('namapenerima') is-invalid @enderror" name="namapenerima" id="namapenerima" value="{{ old('namapenerima',$pelimpahan->namapenerima) }}" onkeyup="hb3()" required>
                      @error('namapenerima')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-5 mb-3">
                      ...
                      <input type="text" class="form-control @error('binpenerima') is-invalid @enderror" name="binpenerima" id="binpenerima" value="{{ old('binpenerima',$pelimpahan->binpenerima) }}" onkeyup="hb4()" required>
                      @error('binpenerima')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-2 mb-3">
                      ...
                      <select class="custom-select" name="jeniskelamin" id="jeniskelamin" required>
                        @foreach ($kelamins as $item)
                          @if (old('jeniskelamin',$pelimpahan->jeniskelamin) == $item->kelamin)
                  ...
                  <div class="form-row">
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control @error('tmplahir') is-invalid @enderror" name="tmplahir" id="tmplahir" value="{{ old('tmplahir',$pelimpahan->tmplahir) }}" required>
                      @error('tmplahir')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="date" class="form-control @error('tgllahir') is-invalid @enderror" name="tgllahir" id="tgllahir" value="{{ old('tgllahir',$pelimpahan->tgllahir) }}" required>
                      @error('tgllahir')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <select class="custom-select" name="hubungan" id="hubungan" required>
                        @foreach ($hubungans as $item)
                          @if (old('hubungan',$pelimpahan->hubungan) == $item->hubungan)
                  ...
                  <div class="form-row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" value="{{ old('alamat',$pelimpahan->alamat) }}" required>
                      @error('alamat')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-1 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('rt') is-invalid @enderror" name="rt" id="rt" value="{{ old('rt',$pelimpahan->rt) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('rt')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-1 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('rw') is-invalid @enderror" name="rw" id="rw" value="{{ old('rw',$pelimpahan->rw) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('rw')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control @error('desa') is-invalid @enderror" name="desa" id="desa" value="{{ old('desa',$pelimpahan->desa) }}" readonly required>
                      @error('desa')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control @error('kec') is-invalid @enderror" name="kec" id="kec" value="{{ old('kec',$pelimpahan->kec) }}" readonly required>
                      @error('kec')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control @error('kab') is-invalid @enderror" name="kab" id="kab" value="{{ old('kab',$pelimpahan->kab) }}" readonly required>
                      @error('kab')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="text" class="form-control @error('prov') is-invalid @enderror" name="prov" id="prov" value="{{ old('prov',$pelimpahan->prov) }}" readonly required>
                      @error('prov')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="pekerjaan" id="pekerjaan" required>
                        @foreach ($pekerjaans as $item)
                          @if (old('pekerjaan',$pelimpahan->pekerjaan) == $item->namapekerjaan)
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="pendidikan" id="pendidikan" required>
                        @foreach ($pendidikans as $item)
                          @if (old('pendidikan',$pelimpahan->pendidikan) == $item->jenjang)
                    ...
                    <div class="col-md-2 mb-3">
                      ...
                      <select class="custom-select" name="goldarah" id="goldarah" required>
                        @foreach ($goldarah as $item)
                          @if (old('goldarah',$pelimpahan->goldarah) == $item->goldarah)
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="skawin" id="skawin" required>
                        @foreach ($skawin as $item)
                          @if (old('skawin',$pelimpahan->skawin) == $item->status)
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="shaji" id="shaji" required>
                        @foreach ($shaji as $item)
                          @if (old('shaji',$pelimpahan->shaji) == $item->status)
                            <option value="{{ $item->status }}" selected="selected">{{ $item->status }}</option>
                          @else
                            <option value="{{ $item->status }}">{{ $item->status }}</option>
                          @endif
                  ...
                  <div class="form-row">
                    <div class="col-md-3 mb-3">
                      ...
                      <select class="custom-select" name="bank" id="bank" required>
                        @foreach ($bank as $item)
                          @if (old('bank',$pelimpahan->bank) == $item->namabank)
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('norek') is-invalid @enderror" name="norek" id="norek" value="{{ old('norek',$pelimpahan->norek) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('norek')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="form-row">
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('ktppemberi') is-invalid @enderror" name="ktppemberi" id="ktppemberi" value="{{ old('ktppemberi',$pelimpahan->ktppemberi) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('ktppemberi')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control iAngka @error('hppemberi') is-invalid @enderror" name="hppemberi" id="hppemberi" value="{{ old('hppemberi',$pelimpahan->hppemberi) }}" onkeypress="return hanyaAngka(event)" required>
                      @error('hppemberi')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-md-5 mb-3">
                      ...
                      <input type="text" class="form-control @error('namapemberi') is-invalid @enderror" name="namapemberi" id="namapemberi" value="{{ old('namapemberi',$pelimpahan->namapemberi) }}" onkeyup="hb5()" required>
                      @error('namapemberi')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="verifikator_id" id="verifikator_id" style="width: 80%;">
                          @foreach ($petugas as $item)
                            @if (old('verifikator_id',$pelimpahan->verifikator_id) == $item->id)
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="pejabat_id" id="pejabat_id" style="width: 80%;">
                          @foreach ($pejabat as $item)
                            @if (old('pejabat_id',$pelimpahan->pejabat_id) == $item->id)
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="simpanalamat" data-dismiss="modal">Simpan</button>
      </div>
      </form>
    </div>
  </div>
