...
@section('konten')
                        ...
                        <form action="/dash/cetakrp">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-success" type="submit" onclick="tampilkan()">Tampilkan &nbsp;<i
    ...
    <script>
        ...
        function datasumber() {
            ...
            // Eksekusi Ajax
            xhr.open('get', '/dash/rekappelimpahan/proses/' + pengajuan, true)
            xhr.send()
            tampilkan()
        }
        ...
        function tampilkan() {
            ...
            // Eksekusi Ajax
            xhr.open('get', '/dash/rekappelimpahan/' + tanggal_tampilkan, true)
            xhr.send()
        }
        ...
        function update(id, proses, tgl) {
            ...
            $.ajax({
                url: "{{ url('dash/rekappelimpahan/edit') }}/" + ids + "/" + teksproses + "/" + tgl_proses,
                type: 'get',
        ...
        $('#rekap-jamaah').on('click', '#updatelagi', function() {
            ...
            function updatelagi(id, proses, tgl) {
                ...
                $.ajax({
                    url: "{{ url('dash/rekappelimpahan/ubah') }}/" + idValue + "/" + teksproses + "/" +
                        tanggal,
                    type: 'get',
                    success: function(data) {
                        datasumber();
