...
<html lang="en">
  <head>
    ...
    <title>Pembatalan Pribadi</title>
  </head>
  <body>
    ...
    <section id="hal2">
      <div class="page-break">
        ...
        <div class="row mt-1 mr-2">
          <div class="col">
              <p style="margin-bottom: -2px;"><i>Assalamu'alaikum Wr. Wb.</i></p>
              <p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yang bertanda tangan di bawah ini, saya jamaah calon haji Kabupaten Majalengka dengan keterangan sebagai berikut :</p>
          </div>
        </div>
        ...
        <div class="row mt-2 mr-2">
          <div class="col">
            <p style="text-align: justify;margin-bottom: -2px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Menyatakan mengajukan pengembalian BPIH {{ $pembatalan->setoran }} dikarenakan <b>Alasan Keluarga</b>.</p>
        ...
        <div style="margin-top: -15px;">
          <p style="font-size: 11pt;">Surat Permohonan ini dilampiri :<br>
             ...
             4. Kartu Keluarga<br>
             5. Surat Pernyataan Tanggungjawab Mutlak Calon Jamaah Haji bermaterai
            </p>
        </div>
      </div>
    </section>
    ...
    <section id="hal3">
      <div class="row">
        <div class="col mr-2">
          ...
          <p class="mt-4 mr-4" style="text-align: justify;">Adalah jamaah calon haji yang mengajukan permohonan pembatalan dan pengembalian setoran {{ $pembatalan->setoran }} BPIH. Selanjutnya saya bertanggungjawab mutlak dalam proses pembatalan dan pengembalian setoran BPIH dimaksud sesuai dengan ketentuan yang berlaku dan tidak akan menuntut pihak manapun.</p>
