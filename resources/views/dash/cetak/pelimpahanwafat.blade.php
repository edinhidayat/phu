...
<html lang="en">
  <head>
    ...
    <title>Pelimpahan Meninggal Dunia</title>
  </head>
  <body>
    ...
    <section id="hal1">
      <div class="page-break">
        ...
        <div>
          ...
          <p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bersama ini kami sampaikan, sehubungan dengan adanya Calon Jemaah Haji Kabupaten Majalengka yang meninggal dunia, maka dengan ini kami memberi rekomendasi pelimpahan porsi haji :</p>
        </div>
        ...
        <div class="ml-3" style="margin-top: -15px;">
            <table width=100%>
                ...
                <tr>
                    <td style="width: 150px;">Tgl. Meninggal </td>
                    <td style="width: 10px;text-align:left;">:</td>
    ...
    <section id="hal2">
        <div class="page-break">
          ...
          <table style="border:0;margin-bottom:5px;">
              ...
              <td style="width: 600px;">
                  <p class="text-center" style="margin-bottom: -5px;font-size: 11pt;"><b>FORMULIR PENGAJUAN PELIMPAHAN NOMOR PORSI HAJI MENINGGAL DUNIA</b></p>
          ...
          <div class="row">
            <div class="col-md subjudul1">
              ...
              <div class="subjudul">Tanggal Kematian</div>
      ...
      <div class="page-break">
        <div class="row">
          <div class="col">
            ...
            <div class="text-center"><b>Validasi Dokumen Pelimpahan Porsi Jemaah Haji Meninggal Dunia</b></div>
          </div>
          <div class="mt-3">
          ...
          <p class="mt-2" style="text-align: justify;">Telah dilakukan verifikasi dokumen persyaratan pelimpahan porsi jemaah haji meninggal dunia atas nama {{ $pelimpahan->namajamaah }} BIN {{ $pelimpahan->binjamaah }} nomor porsi {{ $pelimpahan->porsi }} oleh petugas Kantor Kementerian Agama Kabupaten Majalengka bahwa penerima pelimpahan porsi adalah ahli waris yang berhak menerima pelimpahan porsi sesuai dengan ketentuan yang berlaku.</p>
    ...
    <section id="hal4">
      <div class="page-break">
        ...
        <div class="row mt-1 mr-2">
          <div class="col">
              <p style="margin-bottom: -2px;"><i>Assalamu'alaikum Wr. Wb.</i></p>
              <p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bersama ini kami sampaikan, sehubungan Calon Jamaah Haji telah meninggal dunia, maka dengan ini kami mohon pelimpahan porsi haji atas :</p>
          </div>
        </div>
        ...
        <div class="ml-3" style="margin-top: -15px;">
          <table width=100%>
            ...
            <tr>
              <td style="width: 180px;">Tanggal Surat Wafat </td>
              <td style="width: 10px;text-align:left;">:</td>
              <td style="text-align:left;">{{ $pelimpahan->tglsurat }}</td>
            </tr>
          </table>
    ...
    <section id="hal5">
      <div class="row">
        <div class="col mr-2">
          ...
          <div class="text-center"><b>PENERIMA PELIMPAHAN NOMOR PORSI JEMAAH HAJI MENINGGAL DUNIA</b></div>
          ...
          <p class="mt-3" style="text-align: justify;">Bertanggung jawab atas pelimpahan nomor porsi jemaah haji reguler yang meninggal dunia a.n. {{ $pelimpahan->namajamaah }} BIN {{ $pelimpahan->binjamaah }} sesuai dengan surat kuasa yang telah diberikan oleh para pemberi kuasa.</p>
          <p style="text-align: justify;">Apabila dikemudian hari ditemukannya data yang tidak benar atau timbul gugatan atas kuasa penerima pelimpahan nomor porsi jemaah haji meninggal dunia, maka saya siap bertanggung jawab secara administratif dan/atau pidana.</p>
