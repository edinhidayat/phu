      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-7 kotak-isian">
            ...
            <form action="/dash/agenda/{{ $agenda->id }}" method="post">
              @method('put')
              @csrf
              ...
              <div class="row mb-3">
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('agenda') is-invalid @enderror" name="agenda"
                    id="agenda" value="{{ old('agenda', $agenda->agenda) }}" readonly>
                  @error('agenda')
                ...
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('nomoragenda') is-invalid @enderror" name="nomoragenda"
                    id="nomoragenda" value="{{ old('nomoragenda', $agenda->nomoragenda) }}" onfocusout="teksagenda()" autofocus required>
                  @error('nomoragenda')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <select class="form-control select2" name="bulan" id="bulan">
                    @foreach ($bulans as $item)
                      @if (old('bulan', $agenda->bulan) == $item->namabulan)
                ...
                <div class="col-2">
                  ...
                  <select class="form-control select2" name="tahun" id="tahun">
                    @foreach ($tahuns as $item)
                      @if (old('tahun', $agenda->tahun) == $item->tahun)
              ...
              <div class="row mb-3">
                <div class="col-3">
                  ...
                  <input type="date" class="form-control @error('tglregister') is-invalid @enderror" name="tglregister"
                    id="tglregister" value="{{ old('tglregister', $agenda->tglregister) }}" required>
                  @error('tglregister')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="row mb-3">
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('porsi') is-invalid @enderror" name="porsi"
                    id="porsi" value="{{ old('porsi', $agenda->porsi) }}" required>
                  @error('porsi')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="row mb-3">
                <div class="col-6">
                  ...
                  <input type="text" class="form-control @error('namajamaah') is-invalid @enderror" name="namajamaah"
                    id="namajamaah" value="{{ old('namajamaah',$agenda->namajamaah) }}" required>
                  @error('namajamaah')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="row mb-3">
                <div class="col-6">
                  ...
                  <input type="text" class="form-control @error('bin') is-invalid @enderror" name="bin"
                    id="bin" value="{{ old('bin',$agenda->bin) }}" required>
                  @error('bin')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <select class="form-control select2" name="jeniskelamin_id" id="jeniskelamin_id">
                    @foreach ($jeniskelamin as $item)
                      @if (old('jeniskelamin_id',$agenda->jeniskelamin_id) == $item->id)
              ...
              <div class="row mb-3">
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('tempatlahir') is-invalid @enderror"
                    name="tempatlahir" id="tempatlahir" value="{{ old('tempatlahir', $agenda->tempatlahir) }}" required>
                  @error('tempatlahir')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <input type="date" class="form-control @error('tgllahir') is-invalid @enderror" name="tgllahir"
                    id="tgllahir" value="{{ old('tgllahir', $agenda->tgllahir) }}" required>
                  @error('tgllahir')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="row mb-3">
                <div class="col-3">
                  ...
                  <input type="text" class="form-control @error('desa') is-invalid @enderror" name="desa"
                    id="desa" value="{{ old('desa', $agenda->desa) }}" required>
                  @error('desa')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <select class="form-control select2" name="kecamatan_id" id="kecamatan_id">
                    @foreach ($kecamatan as $item)
                      @if (old('kecamatan_id', $agenda->kecamatan_id) == $item->id)
              ...
              <div class="row mb-3">
                <div class="col-3">
                  ...
                  <select class="form-control select2" name="bank_id" id="bank_id">
                    @foreach ($bank as $item)
                      @if (old('bank_id',$agenda->bank_id) == $item->id)
                ...
                <div class="col-3">
                  ...
                  <input type="date" class="form-control @error('tglsetor') is-invalid @enderror" name="tglsetor"
                    id="tglsetor" value="{{ old('tglsetor', $agenda->tglsetor) }}" required>
                  @error('tglsetor')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-3">
                  ...
                  <select class="form-control select2" name="verifikator_id" id="verifikator_id">
                    @foreach ($verifikator as $item)
                      @if (old('verifikator_id', $agenda->verifikator_id) == $item->id)
                ...
                <div class="col-3">
                  ...
                  <select class="form-control select2" name="pejabat_id" id="pejabat_id">
                    @foreach ($pejabat as $item)
                      @if (old('pejabat_id', $agenda->pejabat_id) == $item->id)
