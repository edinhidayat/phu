      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-6">
            ...
            <form action="/dash/user/{{ $user->id }}" method="post">
              @method('put')
              @csrf
              <div class="mb-3">
                <label for="nama" class="form-label">Nama Lengkap</label>
                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                  id="nama" value="{{ old('nama', $user->nama) }}" autofocus required>
                @error('nama')
              ...
              <div class="mb-3 d-flex justify-content-between">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="pengguna_id" style="width: 100%;">
                      @foreach ($penggunas as $item)
                        @if (old('pengguna_id', $user->pengguna_id) == $item->id)
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="active" style="width: 100%;">
                      ...
                      @elseif (old('active', $user->active) == 0)
